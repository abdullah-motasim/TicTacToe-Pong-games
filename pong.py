    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                init.display_start_screen = False
...
def display_start_screen():
    ...
    text1 = init.start_screen_font.render("W and S to move", False, init.light_grey)
    screen.blit(text1, (init.SS1_x, init.SS1_y))

    text2 = init.start_screen_font.render("Up and Down to move", False, init.light_grey)
    screen.blit(text2, (init.SS2_x, init.SS2_y))

    text3 = init.start_screen_font.render("Press Space to Start", False, init.light_grey)
    screen.blit(text3, (init.SS3_x, init.SS3_y))
...
# Main Game Loop
while True:
    if init.display_start_screen:
        display_start_screen()
        handle_inputs()

    elif init.display_game_over:
